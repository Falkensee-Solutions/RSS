...
Flyer, Partnerlogos und Galeriebilder werden mit Sveltia CMS gepflegt und als
JSON bzw. Medien direkt im Repository gespeichert. Jeder bestätigte Commit auf
`main` startet automatisch den GitHub-Pages-Build. Die vollständige Anleitung
steht in `docs/SVELTIA_SETUP.md`.
...
- [ ] Sveltia nach `docs/SVELTIA_SETUP.md` einrichten und die GitHub-OAuth-
      Anmeldung für die Redaktion konfigurieren.
